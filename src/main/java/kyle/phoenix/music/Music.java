...
public class Music extends ListenerAdapter {
    EmbedBuilder adding = new EmbedBuilder();
    ...
    public void onMessageReceived(MessageReceivedEvent event) {
        ...
        if (guild != null) {
            ...
            adding.setAuthor("Added To Queue", null, event.getAuthor().getAvatarUrl());
        }
    }
    ...
    private void loadAndPlay(final TextChannel channel, final String trackUrl) {
        ...
        playerManager.loadItemOrdered(musicManager, trackUrl, new AudioLoadResultHandler() {
            ...
            public void trackLoaded(AudioTrack track) {
                ...
                adding.setDescription("[" + "**" + track.getInfo().title + "**" + "](" + trackUrl + ")");
                adding.setThumbnail(
                        "https://img.youtube.com/vi/" + track.getInfo().uri.substring(32) + "/maxresdefault.jpg");
                channel.sendMessage(adding.build()).queue();
